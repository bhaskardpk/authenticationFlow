...
import { loginFormJson } from "./formJson";
import CustomButton from "@/components/button/customButton";
import { LoginUser } from "@/apiActions/userAction";
...
const LoginPage = () => {
        ...
        if (data) {
          ...
          try {
            const result: any = signIn("credentials", {
              ...
              data: JSON.stringify({ token, ...rest }),
            });
            if (result.error) {
  ...
  // await apiCall()
  return (
    <div className="bg-leftSectionImage bg-no-repeat bg-left-top md:bg-[left_90%] bg-opacity-50">
        ...
        <div className="w-full flex flex-col md:flex-row">
          ...
          <RightSection>
            <div className="w-[344px] mt-[103px] flex-col justify-start items-start gap-4 inline-flex ">
              ...
              <FormLayout>
                <JsonForm onClick={Submit} formJson={loginFormJson}>
              ...
              <div className="w-[328px] h-[54px] flex-col justify-center items-start gap-2 flex">
                ...
                <Link href={paths.public.forgetPassword}>
                  <div className="w-[328px] h-[23px] text-[#99affe] text-base font-normal underline leading-[21.12px]">
                    Forgot password
                  </div>
                </Link>
